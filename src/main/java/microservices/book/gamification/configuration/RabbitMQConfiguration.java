...
public class RabbitMQConfiguration implements RabbitListenerConfigurer {
	 ...
	 * configureRabbitListeners(org.springframework.amqp.rabbit.listener.
	...
	@Bean
	TopicExchange multiplicationExchange(@Value("${multiplication.exchange}") final String exchangeName) {
		return new TopicExchange(exchangeName);
	}

	@Bean
	Queue gamificationMultiplicationQueue(@Value("${multiplication.queue}") final String queueName) {
